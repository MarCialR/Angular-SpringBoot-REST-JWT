/* User */
insert into northwind.user (user_id, password, first_name, last_name, email, company, phone, address1, address2, country, postal, role, is_active, is_blocked, security_provider_id, default_customer_id, secret_question, secret_answer, enable_beta_testing, enable_renewal) values
('demo'      , 'demo'     , 'Mrinmoy'  , 'Majumdar', 'arivera2@joomla.org'    , 'Abshire Inc', '7-(740)701-4547', '80429 Garrison Crossing', '4967'               , 'USA'        , '64890', 'USER' , TRUE, FALSE, 10001, 20000, 'Diverse'       , 'Yellow' , FALSE, FALSE),
('admin'     , 'admin'    , 'Theresa'  , 'Russell' , 'trussell1@about.me'     , 'Glover, Adams and Bins', '383-(779)851-3208', '30874 Graceland Terrace', '99152' , 'USA'        , '51065', 'ADMIN', TRUE, FALSE, 10001, 20000, 'knowledge base', 'Mauv'   , TRUE, FALSE),
('user'      , 'user'     , 'Virginia' , 'Reynolds', 'vreynolds0@slashdot.org', 'Rippin, Osinski and Beatty', '84-(228)809-9998', '0118 Burrows Plaza', '496'     , 'USA'        , '94086', 'USER' , TRUE, FALSE, 10001, 20000, 'Innovative'    , 'Turquoise', TRUE, TRUE),
('jowens3'   , 'jowens3'  , 'Judy'     , 'Owens'   , 'jowens3@hp.com'         , 'Altenwerth, Fisher and Heidenreich', '30-(772)268-8227', '98 Loeprich Way', '447', 'Greece'     , null   , 'USER' , FALSE, FALSE, 10001, 20001, 'capacity'      , 'Fuscia' , TRUE, TRUE),
('kburns4'   , 'kburns4'  , 'Kelly'    , 'Burns'   , 'kburns4@icio.us'        , 'McCullough-Morar', '86-(857)185-5740', '1638 Basil Alley', '56297'               , 'China'      , null   , 'ADMIN', TRUE, FALSE, 10000, 20002, 'user-facing'   , 'Crimson', TRUE, TRUE),
('jshaw5'    , 'jshaw5'   , 'Julie'    , 'Shaw'    , 'jshaw5@opera.com'       , 'Steuber-Okuneva', '1-(871)375-6188', '389 Myrtle Pass', '41444'                  , 'Canada'     , null   , 'ADMIN', TRUE, TRUE, 10000, 20000, 'software'      , 'Green'  , FALSE, TRUE),
...
('jjacobs7'  , 'jjacobs7' , 'Justin'   , 'Jacobs'  , 'jjacobs7@google.co.uk'  , 'Harris-Bashirian', '963-(199)359-2552', '95012 Hanover Street', '2377'           , 'India'      , null   , 'USER' , TRUE, FALSE, 10000, 20002, 'motivating'    , 'Crimson', TRUE, FALSE),
('kbennett8' , 'kbennett8', 'Kevin'    , 'Bennett' , 'kbennett8@hostgator.com', 'Leannon Inc', '62-(892)710-5713', '459 Coleman Drive', '397'                     , 'Indonesia'  , null   , 'ADMIN', FALSE, FALSE, 10001, 20000, 'Exclusive'     , 'Purple' , TRUE, TRUE),
('cmurphy9'  , 'cmurphy9' , 'Chris'    , 'Murphy'  , 'cmurphy9@over-blog.com' , 'Mosciski LLC', '64-(272)961-0086', '2 Ludington Point', '7'                      , 'New Zealand', null   , 'ADMIN', FALSE, TRUE, 10000, 20000, 'empowering'    , 'Maroon' , FALSE, TRUE);
...
,(602, 'P2' , 'Canon EOS 5D Mark IV'  , null, 1382.83, 1293.84, 90 , 15, 15, 56, FALSE, 'Camera')
,(603, 'P3' , 'Dell XPS 13'           , null, 1482.83, 1393.84, 95 , 20, 30, 56, FALSE, 'Laptop')
,(604, 'P4' , 'iPad Air'              , null, 382.83 , 293.84 , 180, 75, 50, 56, FALSE, 'Tablet')
,(605, 'P5' , 'Acer Aspire S 13'      , null, 882.83 , 793.84 , 40 , 15, 15, 56, FALSE, 'Laptop')
...
,(612, 'P12', 'Pentax K-1'            , null, 882.83 , 793.84 , 50 , 10, 5 , 56, FALSE, 'Camera')
,(613, 'P13', 'Asus Zenbook Ux305'    , null, 1182.83, 1093.84, 55 , 10, 5 , 56, FALSE, 'Laptop')
,(614, 'P14', 'HP Envy m7-n109dx 17.3', null, 1382.83, 1293.84, 50 , 10, 10, 56, FALSE, 'Laptop')
,(615, 'P15', 'Microsft Surface Book' , null, 1682.83, 1593.84, 200, 80, 50, 56, FALSE, 'Tablet')
...
/* Order details */
insert into northwind.order_items (order_id, product_id, quantity, unit_price, discount, order_item_status, date_allocated) values
